...
type LogOptions struct {
	...
	MaxSize    int64  `mapstructure:"maxSize"`    // 单文件最大大小(字节)
...
func (o *Options) ConfigureWithViper(vp *viper.Viper) {
	...
	// 日志配置
	o.Logger = LogOptions{
		Dir:        o.getStringWithDefault("logger.dir", "log"),
		Level:      int8(o.getIntWithDefault("logger.level", 0)),
		LineNum:    o.getBoolWithDefault("logger.lineNum", false),
		MaxSize:    o.getInt64WithDefault("logger.maxSize", 500*1024*1024),
	...
	o.Database = DBOptions{
		...
		MaxOpenConns:    o.getIntWithDefault("db.maxOpenConns", 100),
		MaxIdleConns:    o.getIntWithDefault("db.maxIdleConns", 10),
