...
func newCustomer(db *gorm.DB, opts ...gen.DOOption) customer {
	...
	_customer.Gender = field.NewString(tableName, "gender")
	_customer.Birthday = field.NewTime(tableName, "birthday")
	_customer.Level = field.NewString(tableName, "level")
...
type customer struct {
	...
	Birthday   field.Time
	Level      field.String // 客户等级: 普通, 银牌, 金牌, 铂金
	Tags       field.String
	Note       field.String
...
func (c *customer) fillFieldMap() {
	...
	c.fieldMap["assigned_to"] = c.AssignedTo
