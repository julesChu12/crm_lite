...
type WalletTransaction struct {
	...
	WalletID      string    `gorm:"column:wallet_id;type:varchar(36);not null;index:idx_wallet_transactions_wallet_id,priority:1" json:"wallet_id"`
	...
	RelatedID     string    `gorm:"column:related_id;type:varchar(36);index:idx_wallet_transactions_related_id,priority:1;comment:关联ID（如订单ID、退款ID等）" json:"related_id"`                                    // 关联ID（如订单ID、退款ID等）
	Remark        string    `gorm:"column:remark;type:text" json:"remark"`
	OperatorID    string    `gorm:"column:operator_id;type:varchar(36);index:idx_wallet_transactions_operator_id,priority:1;comment:操作人员" json:"operator_id"` // 操作人员
